...
@section('content')
<div style="background-color: #262626;" class="w-full min-h-screen">
    ...
    <section class="py-16 px-6 pt-8 pb-12">
        <div class="max-w-screen-xl mx-auto px-6">
            <h2 class="text-4xl font-bold text-left" style="color: #7d94af; margin-bottom: 1.5rem; padding-left: 0.5rem;">CATEGORIES</h2>
                ...
                @foreach($categories as $category)
                    ...
                    <article style="background-color: #303030;" class="group rounded-md shadow-lg hover:shadow-2xl transition-all duration-300 ease-out overflow-hidden">
                        ...
                        <div class="p-6 md:p-8">
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3 line-clamp-2 flex items-center gap-2">
